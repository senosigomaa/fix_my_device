import 'package:fix_my_device/features/booking/presentation/screens/fault_details_screen.dart';
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => const FaultDetailsScreen(),
                    ),
                  );
                },
                child: const Text(
                  'متابعة لتفاصيل العطل',
                  style: TextStyle(
                    color: Colors.white,
                    fontWeight: FontWeight.bold,
                  ),
